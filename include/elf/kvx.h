...
START_RELOC_NUMBERS (elf_kvx_reloc_type)
    ...
    RELOC_NUMBER (R_KVX_S11S2_PCREL,                          83)
    RELOC_NUMBER (R_KVX_S17S2_PCREL,                          84)
    RELOC_NUMBER (R_KVX_S27S2_PCREL,                          85)
    RELOC_NUMBER (R_KVX_S38S2_PCREL_LO11,                     86)
    RELOC_NUMBER (R_KVX_S38S2_PCREL_UP27,                     87)
    RELOC_NUMBER (R_KVX_S44S2_PCREL_LO17,                     88)
    RELOC_NUMBER (R_KVX_S44S2_PCREL_UP27,                     89)
    RELOC_NUMBER (R_KVX_S54S2_PCREL_LO27,                     90)
