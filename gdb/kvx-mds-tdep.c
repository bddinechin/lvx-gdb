/* Generated target-description for kvx */
...
static struct pseudo_desc kv3_v1_pseudo_regs[] = {
...
static const int kv3_v1_num_pseudo_regs = 48;

static const char *_kv3_v1_sp_name = "r12";
static const char *_kv3_v1_pc_name = "pc";

static int init_kv3_v1_dwarf2gdb(struct gdbarch *gdbarch)
{
	int i;
...
static struct pseudo_desc kv3_v2_pseudo_regs[] = {
	{ "r0r1", NULL, 128, 2, { -1, -1, }, { "r0", "r1"}},
	{ "r2r3", NULL, 128, 2, { -1, -1, }, { "r2", "r3"}},
	{ "r4r5", NULL, 128, 2, { -1, -1, }, { "r4", "r5"}},
	{ "r6r7", NULL, 128, 2, { -1, -1, }, { "r6", "r7"}},
...
static const int kv3_v2_num_pseudo_regs = 48;

static const char *_kv3_v2_sp_name = "r12";
static const char *_kv3_v2_pc_name = "pc";

static int init_kv3_v2_dwarf2gdb(struct gdbarch *gdbarch)
{
	int i;
	memset (dwarf2gdb, -1, sizeof(dwarf2gdb));
	dwarf2gdb[64].name = "pc";
...
static const char *_kv4_v1_sp_name = "r12";
static const char *_kv4_v1_pc_name = "pc";

static int init_kv4_v1_dwarf2gdb(struct gdbarch *gdbarch)
{
	int i;
	memset (dwarf2gdb, -1, sizeof(dwarf2gdb));
	dwarf2gdb[64].name = "pc";
...
const char* kvx_pc_name (struct gdbarch *gdbarch);
const char*
kvx_pc_name (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("kv3-1", archname) == 0) {
		return _kv3_v1_pc_name;
	}
	if (strcmp ("kv3-2", archname) == 0) {
		return _kv3_v2_pc_name;
	}
	if (strcmp ("kv4-1", archname) == 0) {
		return _kv4_v1_pc_name;
	}
	error ("No PC for architecture %s", archname);
}
const char* kvx_sp_name (struct gdbarch *gdbarch);
const char*
kvx_sp_name (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("kv3-1", archname) == 0) {
		return _kv3_v1_sp_name;
	}
	if (strcmp ("kv3-2", archname) == 0) {
		return _kv3_v2_sp_name;
	}
	if (strcmp ("kv4-1", archname) == 0) {
		return _kv4_v1_sp_name;
	}
...
init_dwarf2gdb (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("kv3-1", archname) == 0) {
		init_kv3_v1_dwarf2gdb (gdbarch);
		return;
	}
	if (strcmp ("kv3-2", archname) == 0) {
		init_kv3_v2_dwarf2gdb (gdbarch);
		return;
	}
	if (strcmp ("kv4-1", archname) == 0) {
		init_kv4_v1_dwarf2gdb (gdbarch);
		return;
	}
	error ("Unable to find the dwarf2gdb table for processor %s", archname);
}

int kvx_num_pseudos (struct gdbarch *gdbarch);
int
kvx_num_pseudos (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("kv3-1", archname) == 0)
		return kv3_v1_num_pseudo_regs;
	if (strcmp ("kv3-2", archname) == 0)
		return kv3_v2_num_pseudo_regs;
	if (strcmp ("kv4-1", archname) == 0)
		return kv4_v1_num_pseudo_regs;
...
pseudo_registers (struct gdbarch *gdbarch, int *pseudo_num)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("kv3-1", archname) == 0) {
		*pseudo_num = kv3_v1_num_pseudo_regs;
		return kv3_v1_pseudo_regs;
	}
	if (strcmp ("kv3-2", archname) == 0) {
		*pseudo_num = kv3_v2_num_pseudo_regs;
		return kv3_v2_pseudo_regs;
	}
	if (strcmp ("kv4-1", archname) == 0) {
		*pseudo_num = kv4_v1_num_pseudo_regs;
		return kv4_v1_pseudo_regs;
	}
...
struct type *kvx_pseudo_register_type (struct gdbarch *gdbarch, 
                                      int regnr);
struct type *kvx_pseudo_register_type (struct gdbarch *gdbarch, 
                                      int regnr)
{
...
static void kvx_init_pseudo_register (struct gdbarch *gdbarch, 
...
enum register_status kvx_pseudo_register_read (struct gdbarch *gdbarch, 
                              ...
                              int regnum, gdb_byte *buf)
{
	...
	if (reg->components[0] < 0) kvx_init_pseudo_register (gdbarch, reg);
