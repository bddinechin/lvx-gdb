...
static struct pseudo_desc lvx_v1_pseudo_regs[] = {
...
static const int lvx_v1_num_pseudo_regs = 48;

static const char *_lvx_v1_sp_name = "r12";
static const char *_lvx_v1_pc_name = "pc";

static int init_lvx_v1_dwarf2gdb(struct gdbarch *gdbarch)
{
	int i;
	...
	dwarf2gdb[156].name = "sr1_pl0";
	dwarf2gdb[156].gdb_regno = 92;
	dwarf2gdb[157].name = "sr1_pl1";
	dwarf2gdb[157].gdb_regno = 93;
	dwarf2gdb[158].name = "sr1_pl2";
	dwarf2gdb[158].gdb_regno = 94;
	dwarf2gdb[159].name = "sr1_pl3";
	...
	dwarf2gdb[168].name = "tpcc_pl0";
	dwarf2gdb[168].gdb_regno = 104;
	dwarf2gdb[169].name = "tpcc_pl1";
	dwarf2gdb[169].gdb_regno = 105;
	dwarf2gdb[170].name = "tpcc_pl2";
	dwarf2gdb[170].gdb_regno = 106;
	dwarf2gdb[171].name = "tpcc_pl3";
...
static const int lvx_v2_num_pseudo_regs = 48;

static const char *_lvx_v2_sp_name = "r12";
static const char *_lvx_v2_pc_name = "pc";

static int init_lvx_v2_dwarf2gdb(struct gdbarch *gdbarch)
{
	int i;
	memset (dwarf2gdb, -1, sizeof(dwarf2gdb));
	dwarf2gdb[64].name = "pc";
...
const char* lvx_pc_name (struct gdbarch *gdbarch);
const char*
lvx_pc_name (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("lvx-1", archname) == 0) {
		return _lvx_v1_pc_name;
	}
	if (strcmp ("lvx-2", archname) == 0) {
		return _lvx_v2_pc_name;
	}
	error ("No PC for architecture %s", archname);
}
const char* lvx_sp_name (struct gdbarch *gdbarch);
const char*
lvx_sp_name (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("lvx-1", archname) == 0) {
		return _lvx_v1_sp_name;
	}
	if (strcmp ("lvx-2", archname) == 0) {
		return _lvx_v2_sp_name;
	}
...
init_dwarf2gdb (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("lvx-1", archname) == 0) {
		init_lvx_v1_dwarf2gdb (gdbarch);
		return;
	}
	if (strcmp ("lvx-2", archname) == 0) {
		init_lvx_v2_dwarf2gdb (gdbarch);
		return;
	}
	error ("Unable to find the dwarf2gdb table for processor %s", archname);
}

int lvx_num_pseudos (struct gdbarch *gdbarch);
int
lvx_num_pseudos (struct gdbarch *gdbarch)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("lvx-1", archname) == 0)
		return lvx_v1_num_pseudo_regs;
	if (strcmp ("lvx-2", archname) == 0)
		return lvx_v2_num_pseudo_regs;
...
pseudo_registers (struct gdbarch *gdbarch, int *pseudo_num)
{
	const char *archname = find_tdesc_arch (gdbarch);
	if (strcmp ("lvx-1", archname) == 0) {
		*pseudo_num = lvx_v1_num_pseudo_regs;
		return lvx_v1_pseudo_regs;
	}
	if (strcmp ("lvx-2", archname) == 0) {
		*pseudo_num = lvx_v2_num_pseudo_regs;
		return lvx_v2_pseudo_regs;
	}
...
int lvx_dwarf2_reg_to_regnum (struct gdbarch *gdbarch, int reg);
int lvx_dwarf2_reg_to_regnum (struct gdbarch *gdbarch, int reg)
{
...
const char *lvx_pseudo_register_name (struct gdbarch *gdbarch, int regnr);
const char *lvx_pseudo_register_name (struct gdbarch *gdbarch, int regnr)
{
...
struct type *lvx_pseudo_register_type (struct gdbarch *gdbarch, 
                                      int regnr);
struct type *lvx_pseudo_register_type (struct gdbarch *gdbarch, 
                                      int regnr)
{
...
int lvx_pseudo_register_reggroup_p (struct gdbarch *gdbarch, 
				   int regnum, 
...
static void lvx_init_pseudo_register (struct gdbarch *gdbarch, 
...
enum register_status lvx_pseudo_register_read (struct gdbarch *gdbarch, 
                              ...
                              int regnum, gdb_byte *buf)
{
	...
	if (reg->components[0] < 0) lvx_init_pseudo_register (gdbarch, reg);
...
void lvx_pseudo_register_write (struct gdbarch *gdbarch, 
...
void _initialize_lvx_mds_tdep ();
void
_initialize_lvx_mds_tdep ()
{
}
