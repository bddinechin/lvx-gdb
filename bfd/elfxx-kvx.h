...
#define KVX_KV3_1_PR_LENGTH 3208 /* (64 GPRs + 81 GFRs + 64 * 4 XFRs) * 8 B */
#define KVX_KV3_2_PR_LENGTH 3472 /* (64 GPRs + 114 GFRs + 64 * 4 XFRs) * 8 B */
#define ELF_GREGSET_T_SIZE 560 /* (64 GPRs + 6 GFRs) * 8 B */
